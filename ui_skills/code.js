...
var settings = {
          "url": "http://localhost:8080/api/schedule/skills",
          "method": "GET",
          "headers": {
...
function loadDoc() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    if (this.readyState == 4 && this.status == 200 && this.responseText == "[]") {
      $(".u-text-1").html("Вибачте, вказаний навичок не знайдено: " + document.getElementById("txtSearch").value);
